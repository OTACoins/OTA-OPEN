...
using OTACoins.Infrastructure.Tests;
using Xunit;

namespace OTACoins.SqlServer.Tests
{
    ...
    public class SqlServerLedgerTests : BaseLedgerTests
    {
        public SqlServerLedgerTests()
        {
            ...
            command.CommandText = @"
                DELETE FROM [OTACoins].[RecordMutations];
                DELETE FROM [OTACoins].[Records];
                DELETE FROM [OTACoins].[Transactions];
            ";
