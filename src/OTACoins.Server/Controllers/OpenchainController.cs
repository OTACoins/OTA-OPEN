...
namespace OTACoins.Server.Controllers
{
    [Route("")]
    public class OTACoinsController : Controller
    {
        private readonly IStorageEngine store;
        private readonly TransactionValidator validator;
        private readonly ILogger logger;

        public OTACoinsController(IStorageEngine store, ILogger logger, TransactionValidator validator = null)
        {
            this.store = store;
        ...
        /// <summary>
        /// Gets information about the OTACoins instance.
        /// </summary>
        /// <returns>The task object representing the asynchronous operation.</returns>
        [HttpGet("info")]
